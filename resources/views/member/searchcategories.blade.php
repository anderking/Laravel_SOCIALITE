...
@section('body_class','member_searchcategories')
@section('main_class','member_searchcategories')
...
<div class="jumbotron">
	<h1>No hay articulos publicados en esta categoría</h1>
	<h2><a href="{{ route('member.articles.show',Auth::user()->id) }}">Se el primero en publicar un articulo</a></h2>
</div>
